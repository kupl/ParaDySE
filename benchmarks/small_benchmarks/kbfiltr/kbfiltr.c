...
int irpStack__MinorFunction ;CREST_int(irpStack__MinorFunction);
int devExt__TopOfStack ;CREST_int(devExt__TopOfStack);
  int devExt__Started ;
  int devExt__Removed ;
...
{ int irpStack__MajorFunction ;CREST_int(irpStack__MajorFunction);
int devExt__UpperConnectData__ClassService ;CREST_int(devExt__UpperConnectData__ClassService);
  int Irp__IoStatus__Status ;
  int status ;
  int tmp ;
...
{ int Irp__Tail__Overlay__CurrentStackLocation ;CREST_int(Irp__Tail__Overlay__CurrentStackLocation);
int Irp__CurrentLocation ;CREST_int(Irp__CurrentLocation);
int DeviceObject__DeviceExtension__TopOfStack ;CREST_int(DeviceObject__DeviceExtension__TopOfStack);
  int irpStack ;
  int tmp ;
...
int powerState__DeviceState ;CREST_int(powerState__DeviceState);
int Irp__CurrentLocation ;CREST_int(Irp__CurrentLocation);
int Irp__Tail__Overlay__CurrentStackLocation ;CREST_int(Irp__Tail__Overlay__CurrentStackLocation);
int devExt__TopOfStack ;CREST_int(devExt__TopOfStack);
int powerType ;CREST_int(powerType);
  int tmp ;
...
{ int Irp__IoStatus__Information ;
int irpStack__Parameters__DeviceIoControl__IoControlCode ;CREST_int(irpStack__Parameters__DeviceIoControl__IoControlCode);
int devExt__UpperConnectData__ClassService ;CREST_int(devExt__UpperConnectData__ClassService);
int irpStack__Parameters__DeviceIoControl__InputBufferLength ;CREST_int(irpStack__Parameters__DeviceIoControl__InputBufferLength);
int sizeof__CONNECT_DATA ;CREST_int(sizeof__CONNECT_DATA);
int irpStack__Parameters__DeviceIoControl__Type3InputBuffer ;CREST_int(irpStack__Parameters__DeviceIoControl__Type3InputBuffer);
int sizeof__INTERNAL_I8042_HOOK_KEYBOARD ;CREST_int(sizeof__INTERNAL_I8042_HOOK_KEYBOARD);
int hookKeyboard__InitializationRoutine ;CREST_int(hookKeyboard__InitializationRoutine);
int hookKeyboard__IsrRoutine ;CREST_int(hookKeyboard__IsrRoutine);
  int Irp__IoStatus__Status ;
  int hookKeyboard ;
  int connectData ;
  int status ;
  ...
  int __cil_tmp18 ;
  int __cil_tmp19 ;
int __cil_tmp20 ;CREST_int(__cil_tmp20);
  int __cil_tmp21 ;
  int __cil_tmp22 ;
  int __cil_tmp23 ;
int __cil_tmp24 ;CREST_int(__cil_tmp24);
  int __cil_tmp25 ;
  int __cil_tmp26 ;
  int __cil_tmp27 ;
int __cil_tmp28 ;CREST_int(__cil_tmp28);
int __cil_tmp29 ;CREST_int(__cil_tmp29);
  int __cil_tmp30 ;
  int __cil_tmp31 ;
int __cil_tmp32 ;CREST_int(__cil_tmp32);
  int __cil_tmp33 ;
  int __cil_tmp34 ;
int __cil_tmp35 ;CREST_int(__cil_tmp35);
  int __cil_tmp36 ;
  int __cil_tmp37 ;
int __cil_tmp38 ;CREST_int(__cil_tmp38);
  int __cil_tmp39 ;
  int __cil_tmp40 ;
