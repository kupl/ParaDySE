...
{ int status ;
  int threadHandle; CREST_int(threadHandle) ;
  int DisketteExtension__PoweringDown; CREST_int(DisketteExtension__PoweringDown) ;
  int DisketteExtension__ThreadReferenceCount; CREST_int(DisketteExtension__ThreadReferenceCount) ;
  int DisketteExtension__FloppyThread; CREST_int(DisketteExtension__FloppyThread) ;
  int Irp__IoStatus__Status ;
  int Irp__IoStatus__Information ;
  int Irp__Tail__Overlay__CurrentStackLocation__Control ;
  int ObjAttributes;  CREST_int(ObjAttributes) ;
  int __cil_tmp12 ;
  int __cil_tmp13 ;
...
{ int DeviceObject__DeviceExtension; CREST_int(DeviceObject__DeviceExtension);
  int Irp__Tail__Overlay__CurrentStackLocation; CREST_int(Irp__Tail__Overlay__CurrentStackLocation);
  int Irp__IoStatus__Information ;
  int Irp__IoStatus__Status ;
  int Irp__CurrentLocation;  CREST_int(Irp__CurrentLocation) ;
  int disketteExtension__IsRemoved; CREST_int( disketteExtension__IsRemoved) ;
  int disketteExtension__IsStarted; CREST_int(disketteExtension__IsStarted) ;
  int disketteExtension__TargetObject; CREST_int(disketteExtension__TargetObject) ;
  int disketteExtension__HoldNewRequests ;
  int disketteExtension__FloppyThread; CREST_int(disketteExtension__FloppyThread) ;
  int disketteExtension__InterfaceString__Buffer; CREST_int(disketteExtension__InterfaceString__Buffer) ;
  int disketteExtension__InterfaceString; CREST_int(disketteExtension__InterfaceString) ;
  int disketteExtension__ArcName__Length; CREST_int(disketteExtension__ArcName__Length) ;
  int disketteExtension__ArcName; CREST_int(disketteExtension__ArcName) ;
  int irpSp__MinorFunction; CREST_int(irpSp__MinorFunction) ;
  int IoGetConfigurationInformation__FloppyCount; CREST_int(IoGetConfigurationInformation__FloppyCount) ;
  int irpSp ;
  int disketteExtension ;
  int ntStatus ;
  int doneEvent; CREST_int(doneEvent) ;
  int irpSp___0 ;
  int nextIrpSp ;
...
{ int DeviceObject__DeviceExtension; CREST_int(DeviceObject__DeviceExtension ) ;
  ...
  int disketteExtension__DriveType; CREST_int(disketteExtension__DriveType ) ;
  int disketteExtension__PerpendicularMode ;
  int disketteExtension__DeviceUnit ;
  int disketteExtension__DriveOnValue ;
  int disketteExtension__UnderlyingPDO; CREST_int(disketteExtension__UnderlyingPDO ) ;
  int disketteExtension__InterfaceString; CREST_int(disketteExtension__InterfaceString ) ;
  ...
  int pnpStatus ;
  int doneEvent; CREST_int(doneEvent ) ;
  int fdcInfo; CREST_int(fdcInfo ) ;
  int fdcInfo__BufferCount ;
  int fdcInfo__BufferSize ;
  int fdcInfo__MaxTransferSize; CREST_int(fdcInfo__MaxTransferSize ) ;
  int fdcInfo__AcpiBios; CREST_int(fdcInfo__AcpiBios ) ;
  int fdcInfo__AcpiFdiSupported; CREST_int(fdcInfo__AcpiFdiSupported ) ;
  int fdcInfo__PeripheralNumber; CREST_int(fdcInfo__PeripheralNumber ) ;
  int fdcInfo__BusType ;
  int fdcInfo__ControllerNumber; CREST_int(fdcInfo__ControllerNumber ) ;
  int fdcInfo__UnitNumber; CREST_int(fdcInfo__UnitNumber ) ;
  int fdcInfo__BusNumber; CREST_int(fdcInfo__BusNumber ) ;
  int Dc ;
  int Fp ;
  int disketteExtension ;
  int irpSp ;
  ...
  int irpSp__Context ;
  int InterfaceType ;
  int KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86; CREST_int(KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86 ) ;
  long __cil_tmp42 ;
  int __cil_tmp43 ;
  int __cil_tmp44 ;
  int __cil_tmp45 ;
  int __cil_tmp46; CREST_int(__cil_tmp46 ) ;
  int __cil_tmp47 ;
  int __cil_tmp48 ;
  int __cil_tmp49 ;
...
{ int ntStatus ;
  ...
  int irpStack ;
  int doneEvent; CREST_int(doneEvent ) ;
  int ioStatus; CREST_int(ioStatus ) ;
  int irp__Tail__Overlay__CurrentStackLocation; CREST_int(irp__Tail__Overlay__CurrentStackLocation ) ;
...
int main(void) 
{ int status ;
  int irp; CREST_int(irp) ;
  int pirp ;
  int pirp__IoStatus__Status ;
  int irp_choice; CREST_int(irp_choice) ;
  int devobj; CREST_int(devobj) ;
  int __cil_tmp8 ;
...
int IofCallDriver(int DeviceObject , int Irp ) 
{
  int returnVal2 ;
  int compRetStatus1 ;
  int lcontext; CREST_int(lcontext) ;
...
{ int disketteExtension__HoldNewRequests; CREST_int(disketteExtension__HoldNewRequests ) ;
  int disketteExtension__IsRemoved; CREST_int(disketteExtension__IsRemoved) ;
  int Irp__IoStatus__Information ;
  int disketteExtension__IsStarted; CREST_int(disketteExtension__IsStarted) ;
  int Irp__CurrentLocation; CREST_int(Irp__CurrentLocation) ;
  int Irp__Tail__Overlay__CurrentStackLocation; CREST_int(Irp__Tail__Overlay__CurrentStackLocation) ;
  int disketteExtension__TargetObject; CREST_int(disketteExtension__TargetObject) ;
  int irpSp__Parameters__DeviceIoControl__OutputBufferLength; CREST_int(irpSp__Parameters__DeviceIoControl__OutputBufferLength) ;
  int sizeof__MOUNTDEV_NAME; CREST_int(sizeof__MOUNTDEV_NAME) ;
  int Irp__AssociatedIrp__SystemBuffer; CREST_int(Irp__AssociatedIrp__SystemBuffer) ;
  int mountName__NameLength ;
  int disketteExtension__DeviceName__Length; CREST_int(disketteExtension__DeviceName__Length) ;
  int sizeof__USHORT; CREST_int(sizeof__USHORT) ;
  int disketteExtension__InterfaceString__Buffer; CREST_int(disketteExtension__InterfaceString__Buffer) ;
  int uniqueId__UniqueIdLength ;
  int disketteExtension__InterfaceString__Length; CREST_int(disketteExtension__InterfaceString__Length) ;
  int sizeof__MOUNTDEV_UNIQUE_ID; CREST_int(sizeof__MOUNTDEV_UNIQUE_ID) ;
  int irpSp__Parameters__DeviceIoControl__InputBufferLength; CREST_int(irpSp__Parameters__DeviceIoControl__InputBufferLength) ;
  int sizeof__FORMAT_PARAMETERS; CREST_int(sizeof__FORMAT_PARAMETERS) ;
  int irpSp__Parameters__DeviceIoControl__IoControlCode___1; CREST_int(irpSp__Parameters__DeviceIoControl__IoControlCode___1) ;
  int sizeof__FORMAT_EX_PARAMETERS; CREST_int(sizeof__FORMAT_EX_PARAMETERS) ;
  int formatExParameters__FormatGapLength; CREST_int(formatExParameters__FormatGapLength) ;
  int formatExParameters__SectorsPerTrack; CREST_int(formatExParameters__SectorsPerTrack) ;
  int sizeof__DISK_GEOMETRY; CREST_int(sizeof__DISK_GEOMETRY) ;
  int Irp__IoStatus__Status___0 ;
  int disketteExtension; CREST_int(disketteExtension) ;
  int ntStatus ;
  int outputBufferLength ;
  int lowestDriveMediaType; CREST_int(lowestDriveMediaType) ;
  int highestDriveMediaType; CREST_int(highestDriveMediaType) ;
  int formatExParametersSize; CREST_int(formatExParametersSize) ;
  ...
  int __cil_tmp39 ;
  int __cil_tmp40 ;
  int __cil_tmp41; CREST_int(__cil_tmp41) ;
  int __cil_tmp42 ;
  int __cil_tmp43 ;
  int __cil_tmp44; CREST_int(__cil_tmp44) ;
  int __cil_tmp45; CREST_int(__cil_tmp45) ;
  int __cil_tmp46 ;
  int __cil_tmp47 ;
  int __cil_tmp48 ;
  int __cil_tmp49 ;
  int __cil_tmp50; CREST_int(__cil_tmp50) ;
  int __cil_tmp51 ;
  int __cil_tmp52 ;
  int __cil_tmp53 ;
  int __cil_tmp54 ;
  int __cil_tmp55; CREST_int(__cil_tmp55) ;
  int __cil_tmp56 ;
  int __cil_tmp57 ;
  int __cil_tmp58 ;
  int __cil_tmp59 ;
  int __cil_tmp60; CREST_int(__cil_tmp60) ;
  int __cil_tmp61 ;
  int __cil_tmp62 ;
  int __cil_tmp63 ;
  int __cil_tmp64 ;
  int __cil_tmp65; CREST_int(__cil_tmp65) ;
  int __cil_tmp66; CREST_int(__cil_tmp66) ;
  int __cil_tmp67 ;
  int __cil_tmp68 ;
  int __cil_tmp69; CREST_int(__cil_tmp69) ;
  int __cil_tmp70 ;
  int __cil_tmp71 ;
  int __cil_tmp72; CREST_int(__cil_tmp72) ;
  int __cil_tmp73 ;
  int __cil_tmp74 ;
  int __cil_tmp75; CREST_int(__cil_tmp75) ;
  int __cil_tmp76 ;
  int __cil_tmp77 ;
  int __cil_tmp78; CREST_int(__cil_tmp78) ;
  int __cil_tmp79 ;
  int __cil_tmp80 ;
  int __cil_tmp81; CREST_int(__cil_tmp81) ;
  int __cil_tmp82 ;
  int __cil_tmp83 ;
  int __cil_tmp84 ;
  int __cil_tmp85 ;
  int __cil_tmp86 ;
  int __cil_tmp87 ;
  int __cil_tmp88; CREST_int(__cil_tmp88) ;
  int __cil_tmp89 ;
  int __cil_tmp90 ;
  long __cil_tmp91 ;
...
{ int DriveMediaConstants__driveMediaType__MediaType; CREST_int(DriveMediaConstants__driveMediaType__MediaType ) ;
  int FormatParameters__MediaType; CREST_int(FormatParameters__MediaType) ;
  int FAKE_CONDITION; CREST_int(FAKE_CONDITION) ;
