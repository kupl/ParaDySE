...
{ int ioStatus__Status ;CREST_int(ioStatus__Status);
  int ioctl ;
int event ;CREST_int(event);
  int irp ;
int status ;CREST_int(status);
  int __cil_tmp10 ;
  int __cil_tmp11 ;
  int __cil_tmp12 ;
  int __cil_tmp13 ;
...
{ int deviceExtension__Active ;CREST_int(deviceExtension__Active);
int deviceExtension ;CREST_int(deviceExtension);
  int status ;
int srb ;CREST_int(srb);
int srb__Cdb ;CREST_int(srb__Cdb);
  int cdb ;
  int inquiryDataPtr ;
  int attempt ;
  int tmp ;
int deviceParameterHandle ;CREST_int(deviceParameterHandle);
  int keyValue ;
  {
  {
#line 140
...
int irpSp__Parameters__UsageNotification__Type ;CREST_int(irpSp__Parameters__UsageNotification__Type);
int deviceExtension__PagingPathCountEvent ;CREST_int(deviceExtension__PagingPathCountEvent);
int irpSp__Parameters__UsageNotification__InPath ;CREST_int(irpSp__Parameters__UsageNotification__InPath);
int deviceExtension__PagingPathCount ;CREST_int(deviceExtension__PagingPathCount);
...
int Irp__Tail__Overlay__CurrentStackLocation ;CREST_int(Irp__Tail__Overlay__CurrentStackLocation);
int deviceExtension__TargetDeviceObject ;CREST_int(deviceExtension__TargetDeviceObject);
  int tmp ;
...
{ int deviceExtension__PlayActive ;CREST_int(deviceExtension__PlayActive);
int ioStatus__Status ;CREST_int(ioStatus__Status);
int currentBuffer__Header__AudioStatus ;CREST_int(currentBuffer__Header__AudioStatus);
int irp_CdAudioIsPlayActive ;CREST_int(irp_CdAudioIsPlayActive);
int event ;CREST_int(event);
int status ;CREST_int(status);
int currentBuffer ;CREST_int(currentBuffer);
  int returnValue ;
  long __cil_tmp10 ;
  int __cil_tmp11 ;
...
int srb__Cdb ;CREST_int(srb__Cdb);
int currentIrpStack__Parameters__DeviceIoControl__IoControlCode ;CREST_int(currentIrpStack__Parameters__DeviceIoControl__IoControlCode);
  int Irp__IoStatus__Information ;
int currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength ;CREST_int(currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength);
int currentIrpStack__Parameters__DeviceIoControl__InputBufferLength ;CREST_int(currentIrpStack__Parameters__DeviceIoControl__InputBufferLength);
  int srb__CdbLength ;
  int cdb__CDB10__OperationCode ;
  int srb__TimeOutValue ;
int sizeof__READ_CAPACITY_DATA ;CREST_int(sizeof__READ_CAPACITY_DATA);
int lastSession__LogicalBlockAddress ;CREST_int(lastSession__LogicalBlockAddress);
int cdaudioDataOut__FirstTrack ;CREST_int(cdaudioDataOut__FirstTrack);
int cdaudioDataOut__LastTrack ;CREST_int(cdaudioDataOut__LastTrack);
int sizeof__CDROM_TOC ;CREST_int(sizeof__CDROM_TOC);
int sizeof__SUB_Q_CURRENT_POSITION ;CREST_int(sizeof__SUB_Q_CURRENT_POSITION);
int userPtr__Format ;CREST_int(userPtr__Format);
int sizeof__CDROM_PLAY_AUDIO_MSF ;CREST_int(sizeof__CDROM_PLAY_AUDIO_MSF);
int inputBuffer__StartingM ;CREST_int(inputBuffer__StartingM);
int inputBuffer__EndingM ;CREST_int(inputBuffer__EndingM);
int inputBuffer__StartingS ;CREST_int(inputBuffer__StartingS);
int inputBuffer__EndingS ;CREST_int(inputBuffer__EndingS);
int inputBuffer__StartingF ;CREST_int(inputBuffer__StartingF);
int inputBuffer__EndingF ;CREST_int(inputBuffer__EndingF);
int cdb__PLAY_AUDIO_MSF__OperationCode ;CREST_int(cdb__PLAY_AUDIO_MSF__OperationCode);
int sizeof__CDROM_SEEK_AUDIO_MSF ;CREST_int(sizeof__CDROM_SEEK_AUDIO_MSF);
  int currentIrpStack ;
  int deviceExtension ;
  int cdaudioDataOut ;
int srb ;CREST_int(srb);
int lastSession ;CREST_int(lastSession);
  int cdb ;
  int status ;
int i ;CREST_int(i);
int bytesTransfered ;CREST_int(bytesTransfered);
int Toc ;CREST_int(Toc);
  int tmp ;
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
...
int currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength ;CREST_int(currentIrpStack__Parameters__DeviceIoControl__OutputBufferLength);
int currentIrpStack__Parameters__DeviceIoControl__InputBufferLength ;CREST_int(currentIrpStack__Parameters__DeviceIoControl__InputBufferLength);
int TrackData__0 ;CREST_int(TrackData__0);
  int Irp__IoStatus__Information ;
  int srb__TimeOutValue ;
  int srb__CdbLength ;
int sizeof__CDROM_TOC ;CREST_int(sizeof__CDROM_TOC);
...
int sizeof__CDROM_PLAY_AUDIO_MSF ;CREST_int(sizeof__CDROM_PLAY_AUDIO_MSF);
int sizeof__CDROM_SEEK_AUDIO_MSF ;CREST_int(sizeof__CDROM_SEEK_AUDIO_MSF);
int deviceExtension__Paused ;CREST_int(deviceExtension__Paused);
  int deviceExtension__PlayActive ;
int sizeof__SUB_Q_CHANNEL_DATA ;CREST_int(sizeof__SUB_Q_CHANNEL_DATA);
int sizeof__SUB_Q_CURRENT_POSITION ;CREST_int(sizeof__SUB_Q_CURRENT_POSITION);
int deviceExtension ;CREST_int(deviceExtension);
int srb ;CREST_int(srb);
  int status ;
...
int SubQPtr ;CREST_int(SubQPtr);
int userPtr__Format ;CREST_int(userPtr__Format);
int SubQPtr___0 ;CREST_int(SubQPtr___0);
  int tmp___0 ;
  int tmp___1 ;
  int tmp___2 ;
  int __cil_tmp35 ;
...
{ int Irp__PendingReturned ;CREST_int(Irp__PendingReturned);
int Irp__AssociatedIrp__SystemBuffer ;CREST_int(Irp__AssociatedIrp__SystemBuffer);
...
int we_should_unload ;CREST_int(we_should_unload);
